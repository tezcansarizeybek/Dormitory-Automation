...
CREATE TABLE IF NOT EXISTS `musteri_listesi` (
  ...
  `kira` varchar(100) COLLATE utf8_turkish_ci DEFAULT NULL,
  `odenecekKira` varchar(100) COLLATE utf8_turkish_ci DEFAULT NULL,
  `veliIletisim` varchar(100) COLLATE utf8_turkish_ci DEFAULT NULL,
...
INSERT INTO `musteri_listesi` (`id`, `tc`, `adi`, `soyadi`, `cep_telefonu`, `adres_bilgileri`, `kira`, `odenecekKira`, `veliIletisim`, `oda_numarasi`) VALUES
...
CREATE TABLE IF NOT EXISTS `personel_listesi` (
  ...
  `ise_kira` varchar(100) COLLATE utf8_turkish_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `personel_listesi` (`id`, `tc`, `ad`, `soyad`, `dogum_tarihi`, `telefon`, `adres`, `cocuk_sayisi`, `maas`, `mesai_saati`, `mesai_ucreti`, `ise_kira`) VALUES
